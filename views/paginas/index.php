...
<section class="resumen">
    ...
    <div class="resumen__grid">
        <div <?php aos_animacion(); ?> data-aos-delay="350" class="resumen__bloque">
...
<div class="speakers__grid">
    <?php foreach($ponentes as $ponente) { ?>
        ...
        <picture>
            ...
            <img class="speaker__imagen" width="200" height="350" loading="lazy" src="img/speakers/<?php echo $ponente->imagen; ?>.png" alt="imagen ponente">
        </picture>
