<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label for="categoria" class="formulario__label">Seleciona el día</label>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="text" id="ponentes" class="formulario__input"
    ...
    <div class="formulario__campo">
        ...
        <input min="1" type="number" id="disponibles" class="formulario__input"
        placeholder="Ej. 20" name="disponibles" value="<?php echo $evento->disponibles; ?>">
    </div>
